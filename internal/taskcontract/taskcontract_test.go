...
func TestClaimsDoctorRunWiring_REQ_TOPTIER_S18_T0(t *testing.T) {
	t.Parallel()
	t.Run("gains_check", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("helper_only_opt_out", func(t *testing.T) {
		t.Parallel()
