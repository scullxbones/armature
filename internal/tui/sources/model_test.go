...
func TestSourcesScreen(t *testing.T) {
	...
	state.Issues["T1"] = &materialize.Issue{ID: "T1", Type: "task", SourceLink: "SRC-1"}
	state.Issues["T2"] = &materialize.Issue{ID: "T2", Type: "task", SourceLink: "SRC-1"}
	state.Issues["T3"] = &materialize.Issue{ID: "T3", Type: "task", SourceLink: "SRC-2"}
