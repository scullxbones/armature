...
| `context-report` | main.go, context_report.go | Price fixture-measured main-path CLI payloads by bytes and estimated tokens | **kept-evidence** | Diagnostic meter. Structured stdout for list, ready, show, render-context, and review plus a fixture render-context bundle. Measured against testdata. bytes/4 matches token_budget. |
