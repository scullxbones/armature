...
| `context-report` | main.go, context_report.go | Price static agent-facing artifacts by bytes and estimated tokens | **kept-evidence** | Diagnostic meter. Embedded skills plus CONTEXT.md, docs/commands.md, concepts, and use-cases. bytes/4 matches token_budget. Dynamic payloads are AOC-S3-T2. |
