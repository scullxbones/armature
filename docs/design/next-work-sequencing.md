...
There are **no remaining Tier A Features** in `arm ready`. Next concrete work is **outside Tier A**: the S6→S7 release/front-door vertical (`TOPTIER-S6-T1` and `TOPTIER-S6-T2` are ready; `TOPTIER-S7-T1` waits on S6-T1; S7-T2 then unblocks item 47 T2). Alternatively, hold that vertical and grill an undecomposed Tier B/C row (items 24–33 / 37–45) — do not invent Armature IDs for those rows. Do not treat `TOPTIER-S14-T1` (Tier C, ready) or `TOPTIER-S12-T1` as the successor to the closed AOC/S18/S13 spine.
