...
**Date:** 2026-07-07 (updated 2026-07-08 — F2 grilling session added `TOPTIER-S17` and `LNGHZN-S2`; updated 2026-07-19 — Tier S delivered; Tier A's remaining items decomposed as `LNGHZN-S3`–`S8` and `NXTTN-S3`/`S4`)
...
| # | Item | Source | Armature story |
|---|---|---|---|
| 10 | End-to-end workflow test harness | GAP T2 | `TOPTIER-S3` |
| 11 | Crash/recovery resilience | GAP T3 | `TOPTIER-S4` |
| 12 | Autonomic heartbeats via harness hook | LH C1 | `LNGHZN-S3` |
| 13 | Transition-time delivery gate | LH C4 | `LNGHZN-S4` |
| 14 | Managed worktree lifecycle | LH F1 | `LNGHZN-S5` |
| 15 | Context Economics | Next-Ten №03 | `NXTTN-S3` |
| 16 | Agent-grade error contract | LH C3 | `LNGHZN-S6` |
| 17 | Scope enforcement hardening | GAP T4 | `TOPTIER-S5` |
| 18 | The Paved Road | Next-Ten №04 | `NXTTN-S4` |
| 19 | Make configuration honest | LH D1 | `LNGHZN-S7` |
| 20 | Reviewer self-validation (`arm review validate`) | LH C6 | `LNGHZN-S8` |
| 21 | Reviewer disagreement / consensus policy | Addendum G3 | `TOPTIER-S13` |
